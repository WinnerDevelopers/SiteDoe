...
?>
      ...
      <div class="modal fade" id="modalExclusao" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Deseja realmente exlcuir ?</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal" style="background-color:#636e72">Fechar</button>
              <button type="submit" class="btn btn-primary" style="background-color:#d63031;">Excluir</button>
        ...
        <?php foreach($lista as $linha) { ?>
          <div class="col-md-4">
            <div class="card card-user">
              <div class="image" style="background-image: url(<?php echo $linha['fotoCampanha'] ?>);background-repeat: no-repeat;background-position: center;background-size: cover;">
...
<br>
                        ...
                        <td style="height: 100%;width: 70%;">
                          <h5><?php echo $linha['nomeCampanha'] ?></h5>
                        </td>
                        <td>
                          <p><?php echo $linha['descricaoCampanha'] ?></p>
                        </td>
<br>
                        <td>
                          <p><?php echo $linha['inicioCampanha'] ?> - <?php echo $linha['fimCampanha'] ?></p>
                        </td>
                        <td>
                  </tbody>
                </div>
                <div class="button-container">
                  <button type="button" class="btn view_data" style="background-color:#293985"  id="<?php echo $linha['idCampanha']; ?>">Editar</button>
                  <button type="button" class="btn delete_data" style="background-color:#d63031"  id="<?php echo $linha['idCampanha']; ?>">Excluir</button>
              </form>
