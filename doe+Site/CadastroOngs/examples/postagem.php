        ...
        <div class="row">
          <div class="col-md-4" style="margin: auto;">
            <div class="card card-user">
              <div class="image" style="background-color:#ebecf1">
              ...
              <div class="card-body">
                <div class="author">
                    ...
                    <h6 class="title"><?php echo 'OLá, '.$ong->getNomeOng(); ?></h6>
<br>
                  <p class="description">
                    <div class="form-group">
                        <textarea class="form-control" id="txtDescricao" name="txtDescricao" rows="4" placeholder="digite para fazer uma nova publicação"></textarea>
                    </div>
